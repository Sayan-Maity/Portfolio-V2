  ...
  return (
    <div>
      ...
      <div style={{ width: "100%", background: "#f4f4f4" }}>
        ...
        />
        <SectionTitle mainTitle={sectionTitleItems?.blog?.mainTitle} summary={sectionTitleItems?.blog?.summary} />
          ...
          {mediumBlogInfo?.items?.map((item: any, index: number) => (
            <div className="blog_innerDiv" key={index}>
              ...
              <div className="blog-right">
                ...
                <p>{ToText(item?.description.substring(0, 250))}... <Link to={item.link} target="_blank">read more</Link> </p>
          ...
          {devToBlogInfo?.result?.map((item: any, index: number) => (
            ...
            <div className="blog-right">
              ...
              <div className="time-date">
                ...
                <p className="blog-date">{formatTimestamp(item.readable_publish_date)}</p>
              </div>
              {/* {item?.categories.length > 0 && <p>{item.categories[0]}</p>} */}
            </div>
            </div>
